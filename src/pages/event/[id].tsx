                    ...
                    (Updated on {modifiedDate})
                        ...
                        <div className='my-12'>
                            <Image
                                ...
                                priority
                            />
                            {/* for space b/w if wordings are big, remove justify between and add ml22 for each p tag */}
                            <div className="mt-6 flex justify-between ">
                                <p className="flex items-center  text-gray-500">
                                    ...
                                    <p className="font-bold text-white">{event.schedule.day}</p>
                                </p>
                                <p className="flex items-center text-gray-500">
                                    ...
                                    <p className="font-bold text-white">{event.schedule.time}</p>
                                </p>
                                <p className="flex items-center text-gray-500">
                                    ...
                                    <p className="font-bold text-white">{event.schedule.venue}</p>
                                </p>
                            </div>
                        </div>
